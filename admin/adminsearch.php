            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button class="view"><a href="admindetails.php?ID=<?php echo $row['id'];?>"><i class="fa-solid fa-eye"></i></a></button>
                        <button class="update"><a href="adminupdate.php?ID=<?php echo $row['id'];?>"><i class="fa-solid fa-pen-to-square"></i></a></button>
