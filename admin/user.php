        ...
        <div class="table">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <button><a href="userdetails.php?ID=<?php echo $rows['id'];?>"><i class="fa-solid fa-eye"></i></a></button>
                        <button><a href="userupdate.php?ID=<?php echo $rows['id'];?>"><i class="fa-solid fa-pen-to-square"></i></a></button>
                        <button type="submit" name="delete"><a href="userdelete.php?id=<?php echo $rows['id'];?>"> <i class="fa-solid fa-trash"></i></a></button>
