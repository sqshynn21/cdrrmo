        ...
        <div class="table">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <button class="view" ><a href="evacuationdetails.php?ID=<?php echo $row['id'];?>"><i class="fa-solid fa-eye"></i></a></button>
                        <button class="update"><a href="evacuationupdate.php?ID=<?php echo $row['id'];?>"><i class="fa-solid fa-pen-to-square"></i></a></button>
                        <button class="delete" type="submit" name="delete"><a href="evacuationdelete.php?id=<?php echo $row['id'];?>"><i class="fa-solid fa-trash"></i></a></button>
                    </td>
                </tr>
                <?php } ?>
               </tbody>
